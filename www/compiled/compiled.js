...
class template_0 extends HTMLElement {
  ...
  connectedCallback() {
    document.addEventListener("DOMContentLoaded", function () {
      ccHandler.bind(this,"/template/carousel-caption.html",this.customOnload)()
...
}customElements.define("carousel-caption", template_0);
class template_1 extends HTMLElement {
  ...
  connectedCallback() {
    document.addEventListener("DOMContentLoaded", function () {
      ccHandler.bind(this,"/template/carousel-container.html",this.customOnload)()
    ...
    // there can be other element methods and properties
}customElements.define("carousel-container", template_1);
class template_2 extends HTMLElement {
  ...
  connectedCallback() {
    document.addEventListener("DOMContentLoaded", function () {
      ccHandler.bind(this,"/template/carousel-item.html",this.customOnload)()
    ...
    // there can be other element methods and properties
}customElements.define("carousel-item", template_2);